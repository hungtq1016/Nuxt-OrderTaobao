...
<template>
  ...
  import { Bars3Icon, BellIcon, CalendarIcon, ChartPieIcon, DocumentDuplicateIcon, FolderIcon, HomeIcon, UsersIcon, } from '@heroicons/vue/24/outline'
...
import { BookOpenIcon, ListBulletIcon, PlusIcon } from '@heroicons/vue/24/solid';
