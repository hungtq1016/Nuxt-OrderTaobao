                      ...
                      <div class="flex gap-x-6">
                        ...
                        <div class="flex-auto">
                          <div class="flex items-start gap-x-3">
                            ...
                            <div
                              :class="[statuses[transaction.status], 'rounded-md py-1 px-2 text-xs font-medium ring-1 ring-inset']">
                      ...
                      <div class="flex justify-end">
                        <a :href="transaction.href"
                          class="text-sm font-medium leading-6 text-indigo-600 hover:text-indigo-500">View<span
                            class="hidden sm:inline"> transaction</span><span class="sr-only">, invoice #{{
                              transaction.invoiceNumber }}, {{ transaction.client }}</span></a>
                      </div>
    ...
    <div>
      <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
        <div class="flex items-center justify-between">
          ...
          <a href="#" class="text-sm font-semibold leading-6 text-indigo-600 hover:text-indigo-500">View all<span
              class="sr-only">, clients</span></a>
        </div>
            ...
            <dl class="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
              ...
              <div class="flex justify-between gap-x-4 py-3">
                ...
                <dd class="flex items-start gap-x-2">
                  ...
                  <div
                    :class="[statuses[client.lastInvoice.status], 'rounded-md py-1 px-2 text-xs font-medium ring-1 ring-inset']">
...
useHead({
  title: 'Trang Quản Trị | Order Taobao',
  meta: [
