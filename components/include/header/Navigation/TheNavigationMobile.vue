<template>
    <!-- Mobile menu -->
    <Dialog as="div" class="lg:hidden" @close="emit('close')" :open="mobileMenuOpen">
...
<script setup lang="ts">
    import { Disclosure, DisclosureButton, DisclosurePanel,Dialog,
    DialogPanel, } from '@headlessui/vue'
    import {  XMarkIcon,ChevronDownIcon } from '@heroicons/vue/24/outline'
    const props = defineProps(['callsToAction','mobileMenuOpen','products'])
